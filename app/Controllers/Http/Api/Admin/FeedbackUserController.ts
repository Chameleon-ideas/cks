...
export default class FeedbackUserController extends RestController
{
    ...
    protected async beforeDestoryLoadModel()
    {
          ...
          return this.sendError(
              'Validation Message',
              { message: "You Can't delete this answer because already associated with another user feedback" },
              400
          );
    }
