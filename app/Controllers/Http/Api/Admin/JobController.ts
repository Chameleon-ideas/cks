...
export default class JobController extends RestController
{
    ...
    public async getTotalJobStatus(ctx: HttpContextContract)
        {
            ...
            let get_jobs = await Job.getTotalJobs(params)
            //send response
            this.__is_paginate = false;
            this.__collection = false;
            this.__sendResponse(200,'Retrived job statuses successfully',get_jobs);
            return;
        }
}
