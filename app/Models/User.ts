...
export default class User extends RestModel
{
    ...
    {
        return [
          'user_group_id','created_by','parent_id','user_type','name','nick_name','username','slug','email','mobile_number','dob','age','password','image_url','company_name','company_address','company_mobile_number','company_email_address',
