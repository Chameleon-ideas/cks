...
export default class FeedbackQuestion extends RestModel
{
    public static table = 'feedback_questions'
    ...
    {
        return [
          'created_by_id','question','slug','status','created_at','updated_at','deleted_at'
        ]
    }
