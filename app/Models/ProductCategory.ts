...
export default class ProductCategory extends RestModel
{
    ...
    {
        return [
          'created_by_id','parent_id','title','slug','description','image_url','status','created_at','updated_at','deleted_at'
        ]
    }
