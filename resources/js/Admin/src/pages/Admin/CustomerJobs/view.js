...
const ViewJob = () => {
  ...
  let { slug } = useParams();
  const { loading, data } = useFetch("get_job", "mount", slug+"?created_by_id="+user.parent_id+"&target_id="+user.id);
	...
	<div class="card-header card-default">
			...
			<div class="widget white-bg">
						<div class="row">
								...
								<div class="col-md-2 col-xs-6"> <strong>Contractor</strong>
									<br/>
									<p class="text-muted">{data.created_by.name}</p>
								</div>
						</div>
					  <hr/>
					  <p class="mt-20">
