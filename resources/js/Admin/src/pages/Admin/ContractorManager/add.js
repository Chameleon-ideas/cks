...
const AddManager = () => {
  ...
  const onFinish = (values) => {
    ...
    fd.append('user_status', '0')
    fd.append('status', '0')
    const callback = (receivedData) => {
      return navigate("/admin/contractor-centers");
    };
          ...
          <div className="col-sm-12">
            ...
            >
              ...
              <div className='row'>
                ...
                <div className='col-12 col-md-6'>
                  <BaseInput label="Center Email" name="email" type="text" rules={register.email} />
                </div>
              </div>
              <div className='row'>
                <div className='col-12 col-md-6'>
                  <BaseInput label="Center Phone" name="mobile_number" type="text" rules={[...register.phone, phoneValidation]} />
                </div>
                <div className='col-12 col-md-6'>
