          ...
          <div className="col-sm-12">
            {
              ...
              <Form
                ...
                initialValues={{
                  parent_id: data?.created_by.name,
              ...
              >
                <div className='row'>
                  ...
                  <BaseInput label="Customer" name="parent_id" type="text" disabled/>
                  </div>
                </div>
                <div className='row'>
                ...
                <div className='row'>
                  <div className='col-12 col-md-6'>
                    <BaseInput label="Center Name" name="name" type="text" rules={register.name} />
                  </div>
                  <div className='col-12 col-md-6'>
                    <BaseInput label="Center Email" name="email" type="text" rules={register.email} disabled/>
                  </div>
                </div>
                <div className='row'>
                  <div className='col-12 col-md-6'>
                    <BaseInput label="Center Phone" name="mobile_number" type="text" rules={[...register.phone, phoneValidation]} disabled/>
                  </div>
                  <div className='col-12 col-md-6'>
